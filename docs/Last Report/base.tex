...
Dentro do ficheiro que cria a base de dados, há uma condição que verifica se se encontra criada a base de dados. Caso não exista, é o próprio programa que a cria, através do ficheiro \emph{create.txt}.
